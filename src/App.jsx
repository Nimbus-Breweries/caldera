...
const BREWERY = {
  ...
  subtitle: "BREWING CO.",
  city: "Ashland, Oregon",
  tagline: "Whole Flower Hops. Uncompromised Quality. Since 1997.",
  memberTier: "Crater Points",
  logo: "CB",
  address: "590 Clover Ln, Ashland, OR 97520",
  phone: "(541) 482-4677",
  email: "info@calderabrewing.com",
  website: "calderabrewing.com",
  instagram: "@calderabrewing",
  hours: "Wed-Sun 12-9p",
  description: "First West Coast craft brewery to can its own beer. World Beer Cup Gold. 100% whole flower hops. 45 beers on tap. Two locations in Ashland. Distributed in 16 states and 3 countries. Scratch-made cuisine. Oregon brewed since 1997.",
  accentHue: 270, accentSat: 100,
  heroImages: {
    home: "https://cdn.calderabrewing.com/wp-content/uploads/2019/06/Brewery-front.jpg",
    beers: "https://cdn.calderabrewing.com/wp-content/uploads/2021/03/Caldera-When-Doves-Cryo-IPA.jpg",
    events: "https://cdn.calderabrewing.com/wp-content/uploads/2019/06/caldera-brewery-fred.jpg",
    badges: "https://cdn.calderabrewing.com/wp-content/uploads/2021/03/1.jpg",
    rewards: "https://cdn.calderabrewing.com/wp-content/uploads/2019/06/IPA-1.jpg",
  },
};

const C = {
  bg:"#0C0B08", surface:"#161410", card:"#1E1B15", cardHover:"#28241C",
  border:"#342E24", borderLight:"#403830", text:"#F0EBDD", textMuted:"#A89878", textDim:"#786848",
  accent:`hsl(${BREWERY.accentHue},${BREWERY.accentSat}%,50%)`,
  accentDark:`hsl(${BREWERY.accentHue},${BREWERY.accentSat}%,38%)`,
  accentGlow:`hsl(${BREWERY.accentHue},${BREWERY.accentSat}%,50%,0.22)`,
  accentFaint:`hsl(${BREWERY.accentHue},${BREWERY.accentSat}%,50%,0.08)`,
  teal:"#D4A040", tealDark:"#B88020", tealGlow:"rgba(212,160,64,0.15)",
  success:"#7EBB6C", warning:"#DEAD48", danger:"#E07060", info:"#7EB0D0",
};

const BEERS=[
  {id:"b1",name:"Ashland Amber",style:"American Amber",abv:5.6,ibu:35,pts:25,flagship:true,limited:false,avail:true,desc:"World Beer Cup Gold Medal. Our flagship amber ale with rich caramel malt and balanced hop character. The beer that put Ashland on the craft map.",flavor:{hoppy:40,malty:70,bitter:35,fruity:25,crisp:60},pair:"BBQ ribs, mushroom burger, smoked gouda"},
  {id:"b2",name:"Caldera IPA",style:"American IPA",abv:6.1,ibu:80,pts:30,flagship:true,limited:false,avail:true,desc:"Bright and clean with 100% whole flower hops. Our IPA showcases the cleaner hop profile that sets Caldera apart. Bold bitterness with citrus and pine.",flavor:{hoppy:85,malty:35,bitter:75,fruity:55,crisp:65},pair:"Spicy wings, sharp cheddar, fish tacos"},
  {id:"b3",name:"Mosaic IPA",style:"American IPA",abv:6.5,ibu:65,pts:30,flagship:true,limited:false,avail:true,desc:"Single-hop Mosaic IPA with tropical fruit, berry, and earthy undertones. Clean, bright, and focused. One of our most popular year-round offerings.",flavor:{hoppy:80,malty:30,bitter:55,fruity:75,crisp:65},pair:"Thai curry, poke bowl, citrus salad"},
  {id:"b4",name:"Pale Ale",style:"American Pale Ale",abv:5.4,ibu:40,pts:25,flagship:true,limited:false,avail:true,desc:"Our first canned beer (2005). The beer that made Caldera the first West Coast micro to can. Clean, hoppy, and perfectly balanced.",flavor:{hoppy:65,malty:40,bitter:40,fruity:45,crisp:70},pair:"Grilled chicken, garden salad, fish and chips"},
  {id:"b5",name:"Lawnmower Lager",style:"American Lager",abv:4.7,ibu:15,pts:15,flagship:true,limited:false,avail:true,desc:"Crisp, clean, and built for the Rogue Valley heat. Light body, minimal bitterness, and maximum refreshment. Mow the lawn, crack a Lawnmower.",flavor:{hoppy:10,malty:35,bitter:10,fruity:10,crisp:98},pair:"Cookout fare, chips and dip, grilled fish"},
  {id:"b6",name:"Pilot Rock Porter",style:"American Porter",abv:5.5,ibu:35,pts:25,flagship:true,limited:false,avail:true,desc:"Named for the volcanic neck visible from Ashland. Dark, smooth, with chocolate and coffee notes. A Southern Oregon classic.",flavor:{hoppy:20,malty:80,bitter:30,fruity:15,crisp:40},pair:"Dark chocolate, smoked brisket, bread pudding"},
  {id:"b7",name:"When Doves Cryo",style:"Hazy IPA",abv:6.8,ibu:50,pts:30,flagship:false,limited:false,avail:true,desc:"Our house favorite hazy. Cryo Mosaic hops deliver intense tropical fruit without the grassy bitterness. Unfiltered, soft, and dangerously drinkable.",flavor:{hoppy:70,malty:25,bitter:25,fruity:95,crisp:55},pair:"Poke bowl, mango salsa, coconut shrimp"},
  {id:"b8",name:"Mogli Chocolate Porter",style:"Bourbon BA Imperial Porter",abv:9.5,ibu:40,pts:45,flagship:false,limited:true,avail:true,desc:"Bourbon barrel-aged imperial chocolate porter. Rich, decadent, and warming. Named for the wild child. Limited and beloved.",flavor:{hoppy:10,malty:95,bitter:30,fruity:25,crisp:10},pair:"Dark chocolate truffles, vanilla ice cream, cigar"},
  {id:"b9",name:"Todd's Special Bitter",style:"ESB",abv:5.0,ibu:35,pts:25,flagship:false,limited:false,avail:true,desc:"North American Beer Awards Gold Medal. A proper English-style ESB brewed with whole flower hops. Malty, balanced, and sessionable.",flavor:{hoppy:35,malty:65,bitter:40,fruity:15,crisp:55},pair:"Fish and chips, roast beef, pub nuts"},
  {id:"b10",name:"Ur Bock",style:"Bock",abv:6.5,ibu:25,pts:30,flagship:false,limited:true,avail:true,desc:"North American Beer Awards Gold Medal. Traditional German bock with rich malt character and warming strength. A contemplative pour for cooler evenings.",flavor:{hoppy:15,malty:90,bitter:20,fruity:20,crisp:30},pair:"Roast pork, schnitzel, aged gouda"},
  {id:"b11",name:"Vas Deferens",style:"Double IPA",abv:8.0,ibu:80,pts:40,flagship:false,limited:true,avail:true,desc:"NABA Gold Medal. A bold double IPA with an even bolder name. Massive hop character with a clean, bitter finish. Not for the faint of heart.",flavor:{hoppy:95,malty:40,bitter:85,fruity:60,crisp:45},pair:"Aged cheddar, carnitas, smoked brisket"},
  {id:"b12",name:"Caldera Root Beer",style:"Root Beer (NA)",abv:0.0,ibu:0,pts:10,flagship:false,limited:false,avail:true,desc:"House-made craft root beer. Creamy, spiced, and made with the same care as our ales. Perfect for the whole family or the designated driver.",flavor:{hoppy:0,malty:40,bitter:5,fruity:30,crisp:80},pair:"Pizza, pretzels, anything"},
];

const EVENTS_INIT=[
  {id:"e1",name:"45 Taps Night",date:"2026-04-10",time:"4:00 PM",desc:"All 45 taps flowing. This is what 28,000 square feet and two brewhouses look like in action. Grab a flight and explore.",rsvpCount:48,capacity:80,tag:"Weekly"},
  {id:"e2",name:"Barrel-Aged Release",date:"2026-05-09",time:"12:00 PM",desc:"New Mogli Chocolate Imperial Porter vintage. Bourbon barrel-aged, limited bottles, and draft pours. The wild child returns.",rsvpCount:72,capacity:120,tag:"Release"},
  {id:"e3",name:"Whole Flower Hop Fest",date:"2026-09-19",time:"12:00 PM",desc:"Celebrating our commitment to 100% whole flower hops. Special single-hop variants, hop education, and scratch-made cuisine pairings.",rsvpCount:86,capacity:150,tag:"Release"},
  {id:"e4",name:"Tap House Trivia",date:"2026-04-08",time:"7:00 PM",desc:"Weekly trivia at the Water Street Tap House. Craft beer, good company, and bragging rights in downtown Ashland.",rsvpCount:28,capacity:50,tag:"Weekly"},
  {id:"e5",name:"Chef's Pairing Dinner",date:"2026-05-16",time:"6:00 PM",desc:"Chef David Kay pairs five courses with five Caldera beers. All made from scratch, all locally sourced. Limited to 24 seats.",rsvpCount:20,capacity:24,tag:"Dinner"},
];
const BADGES=[
  {id:"first-visit",name:"First Eruption",desc:"Check in for the first time",icon:"Beer",req:1,type:"checkin"},
  {id:"regular",name:"Crater Regular",desc:"10 check-ins",icon:"TrendingUp",req:10,type:"checkin"},
  {id:"dedicated",name:"Ashland Local",desc:"25 check-ins",icon:"Shield",req:25,type:"checkin"},
  {id:"legend",name:"Rogue Valley Legend",desc:"50 check-ins",icon:"Trophy",req:50,type:"checkin"},
  {id:"century",name:"Volcanic Century",desc:"100 check-ins",icon:"Award",req:100,type:"checkin"},
  ...
  {id:"connoisseur",name:"Whole Flower Scholar",desc:"Rate all beers",icon:"Heart",req:12,type:"rating"},
  {id:"social",name:"Community Member",desc:"RSVP to 3 events",icon:"Users",req:3,type:"rsvp"},
  {id:"eventgoer",name:"Siskiyou Regular",desc:"RSVP to 8 events",icon:"Calendar",req:8,type:"rsvp"},
];
const REWARDS_INIT=[
  {id:"r1",name:"Free Pint",pts:500,desc:"Any of our 45 taps",icon:"Beer",active:true},
  {id:"r2",name:"Flight Sampler",pts:350,desc:"4-beer tasting flight",icon:"Droplets",active:true},
  {id:"r3",name:"Merch Credit",pts:750,desc:"$15 toward Caldera merch",icon:"Gift",active:true},
  {id:"r4",name:"6-Pack To Go",pts:800,desc:"Any 6-pack of cans",icon:"Beer",active:true},
  {id:"r5",name:"Dinner for Two",pts:2000,desc:"Scratch-made dinner for two",icon:"Sparkles",active:true},
  {id:"r6",name:"Chef's Table Seat",pts:2500,desc:"Reserved seat at pairing dinner",icon:"MapPin",active:true},
];
...
const ACTIVITY=[
  ...
  {type:"checkin",who:"Emily R.",what:"checked in (45 Taps Night)",when:"32 min ago"},
  {type:"level",who:"Chris B.",what:"reached Silver status",when:"1 hr ago"},
  {type:"checkin",who:"Jordan L.",what:"checked in",when:"1.5 hr ago"},
  {type:"rating",who:"Priya P.",what:"rated Ashland Amber 5 stars",when:"2 hr ago"},
];

// HELPERS
const LEVELS=[{name:"Bronze",min:0,color:C.accent},{name:"Silver",min:2500,color:"#94a3b8"},{name:"Gold",min:6000,color:C.warning},{name:"Platinum",min:12000,color:"#D4A040"}];
...
const levelColor=l=>l==="platinum"?"#D4A040":l==="gold"?C.warning:l==="silver"?"#94a3b8":C.accent;

// FONTS & STYLES — Teko display + Asap body
const font=`'Asap',system-ui,-apple-system,sans-serif`;
const fontD=`'Teko','Asap',system-ui,sans-serif`;
const css=`
@import url('https://fonts.googleapis.com/css2?family=Asap:ital,wght@0,400;0,500;0,600;0,700;0,800&family=Teko:wght@400;500;600;700&display=swap');
...
const S={
  ...
  sectionTitle:{fontFamily:fontD,fontWeight:600,fontSize:36,letterSpacing:1,textTransform:"uppercase"},
...
const PageHero=({image,title,subtitle,children})=>(
  <div style={{position:"relative",height:208,overflow:"hidden",marginBottom:16}}>
    ...
    <div style={{position:"relative",zIndex:1,height:"100%",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:"0 20px 18px"}}>
      <div style={{fontFamily:fontD,fontWeight:600,fontSize:36,letterSpacing:1,textTransform:"uppercase",lineHeight:1}}>{title}</div>
      {subtitle&&<div style={{fontSize:16,color:C.textMuted,marginTop:4,fontWeight:500}}>{subtitle}</div>}
      {children}
    </div>
  </div>
);
...
export default function BreweryLoyaltyApp({isAdmin=false,onOpenAdmin,onExitAdmin}){
  ...
  const[user,setUser]=useState({
    name:"Ashland Local",email:"crater@example.com",birthday:"1990-06-15",
    pts:1680,checkIns:14,memberSince:"Oct 2025",
    badges:["first-visit","regular","taster"],rsvps:["e1","e3"],
    ratings:{b1:{r:5,n:"World Beer Cup Gold."},b3:{r:5,n:"Mosaic perfection."},b7:{r:4,n:"When Doves Cryo delivers."},b6:{r:4,n:""}},
  ...
  const Header=()=>(
    <div style={{background:C.surface,borderBottom:`1px solid ${C.border}`,padding:"14px 20px",display:"flex",alignItems:"center",justifyContent:"space-between",position:"sticky",top:0,zIndex:40}}>
      <div style={{display:"flex",alignItems:"center",gap:12}}>
        <div style={{width:38,height:38,background:`linear-gradient(135deg,${C.accent},${C.accentDark})`,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:fontD,fontWeight:600,fontSize:15,letterSpacing:1,color:"#fff",borderRadius:4}}>{BREWERY.logo}</div>
        <div><div style={{fontFamily:fontD,fontWeight:600,fontSize:17,letterSpacing:2,textTransform:"uppercase"}}>{BREWERY.name}</div><div style={{fontSize:12,color:C.textDim,fontWeight:600,letterSpacing:1.5,textTransform:"uppercase"}}>{BREWERY.subtitle}</div></div>
      </div>
  ...
  const NavBar=()=>{const tabs=[{id:"home",icon:Home,label:"Home"},{id:"beers",icon:Beer,label:"Beers"},{id:"events",icon:Calendar,label:"Events"},{id:"badges",icon:Award,label:"Badges"},{id:"rewards",icon:Gift,label:"Rewards"}];return(
    <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:430,background:C.surface,borderTop:`1px solid ${C.border}`,display:"flex",zIndex:40,paddingBottom:"env(safe-area-inset-bottom,0px)"}}>
  ...
  const AdminNav=()=>{const tabs=[{id:"dashboard",icon:LayoutDashboard,label:"Dashboard"},{id:"scanner",icon:Scan,label:"Scanner"},{id:"beers",icon:Beer,label:"Beers"},{id:"events",icon:Calendar,label:"Events"},{id:"rewards",icon:Gift,label:"Rewards"},{id:"broadcast",icon:Megaphone,label:"Broadcast"},{id:"settings",icon:Settings,label:"Settings"}];return(
    <div className="noscr" style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:430,background:C.surface,borderTop:`1px solid ${C.border}`,display:"flex",zIndex:40,overflowX:"auto",paddingBottom:"env(safe-area-inset-bottom,0px)"}}>
  ...
  const HomeScreen=()=>(<div className="enter" style={{paddingBottom:20}}>
    ...
    <div style={{padding:"0 16px"}}>
      <div className="shimmer gp" style={{background:`linear-gradient(135deg,${C.surface},${C.card})`,border:`1px solid ${C.border}`,borderRadius:12,padding:"24px 20px",marginBottom:14,position:"relative",overflow:"hidden"}}>
        ...
        <div style={{position:"relative",zIndex:1}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
            <div><div style={{fontSize:13,fontWeight:700,color:C.accent,letterSpacing:2,textTransform:"uppercase",marginBottom:4}}>{BREWERY.memberTier}</div><div style={{fontFamily:fontD,fontSize:46,fontWeight:600,letterSpacing:-1,lineHeight:1}}>{user.pts.toLocaleString()}</div><div style={{fontSize:14,fontWeight:600,color:level.color,marginTop:6,textTransform:"uppercase",letterSpacing:1}}>{level.name} Member</div></div>
      ...
      <div style={{background:`linear-gradient(135deg,${C.tealDark},${C.teal})`,borderRadius:12,padding:20,color:"#fff"}}>
        <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12}}><Award size={18}/><span style={{fontFamily:fontD,fontWeight:600,fontSize:16,letterSpacing:1,textTransform:"uppercase"}}>Your {level.name} Perks</span></div>
  ...
  const EventsScreen=()=>(<div className="enter" style={{paddingBottom:20}}>
    ...
    <div style={{padding:"0 16px",display:"flex",flexDirection:"column",gap:10}}>
      {events.map(ev=>{const isR=user.rsvps.includes(ev.id);const spots=ev.capacity-ev.rsvpCount-(isR?1:0);const d=new Date(ev.date+"T12:00:00");return(<div key={ev.id} style={{...S.cardP,position:"relative",overflow:"hidden"}}>
        ...
        <div style={{fontFamily:fontD,fontWeight:600,fontSize:18,textTransform:"uppercase",marginBottom:4,paddingRight:70}}>{ev.name}</div>
  ...
  const BadgesScreen=()=>(<div className="enter" style={{paddingBottom:20}}>
    ...
    <div style={{padding:"0 16px",display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
      {BADGES.map(b=>{const earned=earnedBadges.find(e=>e.id===b.id);const I=getIcon(b.icon);const prog=b.type==="checkin"?Math.min(user.checkIns/b.req,1):b.type==="rating"?Math.min(Object.keys(user.ratings).length/b.req,1):Math.min(user.rsvps.length/b.req,1);return(<div key={b.id} style={{background:earned?C.card:C.surface,border:`1px solid ${earned?C.accent+"40":C.border}`,borderRadius:12,padding:18,textAlign:"center",opacity:earned?1:.5,position:"relative"}}>
        ...
        <div style={{fontFamily:fontD,fontWeight:600,fontSize:15,textTransform:"uppercase",marginBottom:4}}>{b.name}</div>
  ...
  const RewardsScreen=()=>(<div className="enter" style={{paddingBottom:20}}>
    ...
    <div style={{padding:"0 16px",display:"flex",flexDirection:"column",gap:10}}>
      {rewards.filter(r=>r.active).map(rw=>{const can=user.pts>=rw.pts;const I=getIcon(rw.icon);return(<div key={rw.id} style={{...S.cardP,display:"flex",alignItems:"center",gap:14,opacity:can?1:.6,border:`1px solid ${can?C.accent+"40":C.border}`}}>
        ...
        <div style={{flex:1}}><div style={{fontFamily:fontD,fontWeight:600,fontSize:16,textTransform:"uppercase"}}>{rw.name}</div><div style={{fontSize:15,color:C.textMuted,marginTop:2}}>{rw.desc}</div></div>
        <div style={{textAlign:"right",flexShrink:0}}><div style={{fontFamily:fontD,fontWeight:600,fontSize:18,color:can?C.accent:C.textDim}}>{rw.pts.toLocaleString()}</div><div style={{fontSize:12,color:C.textDim,textTransform:"uppercase"}}>pts</div></div>
      </div>)})}
    </div>
  </div>);
  ...
  const AdminDashboard=()=>{const stats=[{l:"Members",v:"156",sub:"+8 this month",i:Users,c:C.info},{l:"Check-ins",v:"1,247",sub:"+34 today",i:TrendingUp,c:C.accent},{l:"Badges",v:"312",sub:"all members",i:Award,c:C.teal},{l:"Rewards",v:"89",sub:"$2,140 value",i:Gift,c:C.warning}];const lvls=[{n:"Bronze",c:C.accent,ct:62,pct:40},{n:"Silver",c:"#94a3b8",ct:48,pct:31},{n:"Gold",c:C.warning,ct:34,pct:22},{n:"Platinum",c:"#D4A040",ct:12,pct:7}];return(
    <div className="enter" style={{padding:"16px 16px 100px"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14}}>{stats.map((s,i)=>{const I=s.i;return(<div key={i} style={{...S.cardP}}><div style={{display:"flex",alignItems:"center",gap:6,marginBottom:8}}><I size={16} color={s.c}/><span style={{...S.label}}>{s.l}</span></div><div style={{fontFamily:fontD,fontWeight:600,fontSize:30}}>{s.v}</div><div style={{fontSize:13,color:C.accent,marginTop:2}}>{s.sub}</div></div>)})}</div>
      <div style={{background:`linear-gradient(135deg,${C.accent},${C.accentDark})`,borderRadius:12,padding:16,marginBottom:14,color:"#fff"}}><div style={{display:"flex",alignItems:"center",gap:8,marginBottom:10}}><Clock size={16}/><span style={{fontWeight:700,textTransform:"uppercase",letterSpacing:1,fontSize:15}}>Today</span></div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,textAlign:"center"}}>{[{v:"34",l:"Check-ins"},{v:"6",l:"New"},{v:"12",l:"Rewards"}].map((d,i)=>(<div key={i}><div style={{fontFamily:fontD,fontWeight:600,fontSize:26}}>{d.v}</div><div style={{fontSize:12,opacity:.8,textTransform:"uppercase"}}>{d.l}</div></div>))}</div></div>
  ...
  const AdminScanner=()=>{const[search,setSearch]=useState("");const[selected,setSelected]=useState(null);const[checkType,setCheckType]=useState("regular");const filtered=search?MOCK_MEMBERS.filter(m=>m.name.toLowerCase().includes(search.toLowerCase())):[];const types=[{id:"regular",l:"Regular",pts:50,i:Zap},{id:"happyHour",l:"Happy Hour",pts:100,i:Clock},{id:"event",l:"Event",pts:125,i:Calendar},{id:"dog",l:"With Pup",pts:125,i:Dog}];return(
    <div className="enter" style={{padding:"16px 16px 100px"}}>
      ...
      </>:<><div style={{...S.cardP,marginBottom:14}}><div style={{display:"flex",alignItems:"center",gap:14,marginBottom:14}}><div style={{width:56,height:56,background:C.accentFaint,borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center"}}><User size={28} color={C.accent}/></div><div><div style={{fontFamily:fontD,fontWeight:600,fontSize:22,textTransform:"uppercase"}}>{selected.name}</div><div style={{display:"flex",alignItems:"center",gap:8,marginTop:4}}><span style={{padding:"3px 8px",borderRadius:4,fontSize:12,fontWeight:700,textTransform:"uppercase",background:levelColor(selected.level)+"20",color:levelColor(selected.level)}}>{selected.level}</span><span style={{fontSize:15,color:C.textMuted}}>{selected.pts} pts</span></div></div></div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,background:C.surface,borderRadius:8,padding:12,textAlign:"center"}}>{[{v:selected.pts,l:"Points",c:C.accent},{v:selected.checkIns,l:"Check-ins",c:C.text},{v:selected.badges,l:"Badges",c:C.teal}].map((s,i)=>(<div key={i}><div style={{fontFamily:fontD,fontWeight:600,fontSize:20,color:s.c}}>{s.v}</div><div style={{fontSize:12,color:C.textDim,textTransform:"uppercase"}}>{s.l}</div></div>))}</div></div>
  ...
  const SettingsModal=()=>{const[name,setName]=useState(user.name);const[email,setEmail]=useState(user.email);const[bday,setBday]=useState(user.birthday);const[notifs,setNotifs]=useState({...user.notifications});const handleSave=()=>{setUser(u=>({...u,name,email,birthday:bday,notifications:notifs}));showToast("Profile updated!");setModal(null)};return(
    <div className="fin" style={{position:"fixed",inset:0,zIndex:50,display:"flex",alignItems:"flex-end",justifyContent:"center"}}><div style={{position:"absolute",inset:0,background:"rgba(0,0,0,.85)",backdropFilter:"blur(8px)"}} onClick={()=>setModal(null)}/><div className="sup" style={{position:"relative",width:"100%",maxWidth:430,maxHeight:"90vh",overflowY:"auto",background:C.surface,borderRadius:"16px 16px 0 0"}}>
      ...
      <div style={{padding:20}}>
        ...
        <div style={{background:C.card,border:`1px solid ${C.border}`,borderLeft:`3px solid ${C.accent}`,borderRadius:10,padding:16,marginBottom:16}}><div style={{display:"flex",alignItems:"center",gap:6,...S.label,marginBottom:8}}><Calendar size={14} color={C.accent}/> Member Since</div><div style={{fontFamily:fontD,fontWeight:600,fontSize:20}}>{user.memberSince}</div><div style={{display:"flex",gap:16,marginTop:10}}><div><div style={{fontSize:22,fontFamily:fontD,fontWeight:600,color:C.accent}}>{user.checkIns}</div><div style={{fontSize:12,color:C.textDim}}>Check-ins</div></div><div><div style={{fontSize:22,fontFamily:fontD,fontWeight:600,color:C.teal}}>{earnedBadges.length}</div><div style={{fontSize:12,color:C.textDim}}>Badges</div></div><div><div style={{fontSize:22,fontFamily:fontD,fontWeight:600,color:C.warning}}>{Object.keys(user.ratings).length}</div><div style={{fontSize:12,color:C.textDim}}>Ratings</div></div></div></div>
  ...
  const RsvpModal=({ev})=>{const d=new Date(ev.date+"T12:00:00");return(
    <div className="fin" style={{position:"fixed",inset:0,zIndex:50,display:"flex",alignItems:"flex-end",justifyContent:"center"}}>
      <div style={{position:"absolute",inset:0,background:"rgba(0,0,0,.85)",backdropFilter:"blur(8px)"}} onClick={()=>setModal(null)}/>
      <div className="sup" style={{position:"relative",width:"100%",maxWidth:430,background:C.surface,borderRadius:"16px 16px 0 0",overflow:"hidden"}}>
        <div style={{background:`linear-gradient(135deg,${C.accent},${C.accentDark})`,padding:"20px 20px 16px"}}>
          <button onClick={()=>setModal(null)} style={{position:"absolute",top:14,right:14,width:32,height:32,background:"rgba(0,0,0,.25)",borderRadius:"50%",border:"none",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",color:"#fff"}}><X size={16}/></button>
          <div style={{fontSize:11,fontWeight:700,letterSpacing:2,textTransform:"uppercase",color:"rgba(255,255,255,.7)",marginBottom:6}}>Confirm RSVP</div>
          <div style={{fontFamily:fontD,fontWeight:700,fontSize:22,textTransform:"uppercase",color:"#fff",lineHeight:1.1}}>{ev.name}</div>
        </div>
        <div style={{padding:20}}>
          <div style={{display:"flex",gap:20,marginBottom:16}}>
            <div style={{display:"flex",alignItems:"center",gap:6,fontSize:14,color:C.textMuted}}><Calendar size={14} color={C.accent}/>{d.toLocaleDateString("en-US",{weekday:"short",month:"long",day:"numeric"})}</div>
            <div style={{display:"flex",alignItems:"center",gap:6,fontSize:14,color:C.textMuted}}><Clock size={14} color={C.accent}/>{ev.time}</div>
          </div>
          <div style={{fontSize:15,color:C.textMuted,lineHeight:1.6,marginBottom:16}}>{ev.desc}</div>
          <div style={{background:C.accentFaint,border:`1px solid ${C.accent}30`,borderRadius:10,padding:"10px 14px",marginBottom:20,display:"flex",alignItems:"center",gap:8}}>
            <Bell size={14} color={C.accent}/>
            <span style={{fontSize:13,color:C.accent,fontWeight:600}}>You'll get a reminder before the event</span>
          </div>
          <button onClick={()=>{toggleRSVP(ev.id);setModal(null)}} style={{...S.btnPrimary,width:"100%",justifyContent:"center",padding:14,marginBottom:10}}><Check size={15}/> Confirm RSVP</button>
          <button onClick={()=>setModal(null)} style={{...S.btnGhost,width:"100%",justifyContent:"center"}}>Not this time</button>
        </div>
      </div>
    </div>)};

  const CancelRsvpModal=({ev})=>(
    <div className="fin" style={{position:"fixed",inset:0,zIndex:50,display:"flex",alignItems:"center",justifyContent:"center",padding:"0 20px"}}>
      <div style={{position:"absolute",inset:0,background:"rgba(0,0,0,.85)",backdropFilter:"blur(8px)"}} onClick={()=>setModal(null)}/>
      <div className="sup" style={{position:"relative",width:"100%",maxWidth:380,background:C.surface,borderRadius:16,padding:24,textAlign:"center"}}>
        <div style={{width:48,height:48,background:"rgba(239,68,68,.1)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 14px"}}><X size={22} color={C.danger}/></div>
        <div style={{fontFamily:fontD,fontWeight:700,fontSize:18,textTransform:"uppercase",marginBottom:8}}>Cancel RSVP?</div>
        <div style={{fontSize:15,color:C.textMuted,lineHeight:1.5,marginBottom:20}}>Remove your spot for <b style={{color:C.text}}>{ev.name}</b>?</div>
        <button onClick={()=>{toggleRSVP(ev.id);setModal(null)}} style={{...S.btnGhost,width:"100%",justifyContent:"center",border:`1px solid ${C.danger}`,color:C.danger,marginBottom:10}}>Yes, cancel my RSVP</button>
        <button onClick={()=>setModal(null)} style={{...S.btnPrimary,width:"100%",justifyContent:"center"}}>Keep my spot</button>
      </div>
    </div>);
  ...
  if(isAdmin) return(
    <div style={{position:"fixed",inset:0,display:"flex",fontFamily:font,background:"#0e0810",zIndex:9999,overflow:"hidden"}}>
      <aside style={{width:240,flexShrink:0,background:"#181018",borderRight:"1px solid rgba(255,255,255,.08)",display:"flex",flexDirection:"column",height:"100vh",overflowY:"auto"}}>
      ...
      <main style={{flex:1,overflowY:"auto",background:"#0e0810"}}>
        <div style={{borderBottom:"1px solid rgba(255,255,255,.08)",background:"#181018",padding:"16px 32px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <div>
