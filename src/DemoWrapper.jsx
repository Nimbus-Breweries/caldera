...
export default function DemoWrapper() {
  ...
  const accent     = "#6a00d0";
  const accentDark = "#4e0099";

  return (
    <div style={{
      display: "flex", height: "100vh", overflow: "hidden",
      background: "radial-gradient(ellipse at 50% 110%, rgba(80,30,160,.4) 0%, transparent 55%), radial-gradient(ellipse at 50% 50%, #120a20 0%, #080510 55%, #040208 100%)",
      ...
      {!isAdmin && (
        <div className="demo-sidebar-left side-scroll" style={{
          ...
          <div style={{ marginBottom: 32 }}>
            <div style={{fontSize: 22, fontWeight: 900, color: "#fff", letterSpacing: 2}}>{C.logo}</div>
      ...
      {isAdmin ? (
        ...
        <div className="demo-center" style={{
          ...
          <div style={{
            ...
            background: "#0a0a0a",
            borderRadius: 52,
            boxShadow: "0 0 0 1px #1a1a1a, 0 40px 100px rgba(0,0,0,.9), 0 12px 40px rgba(0,0,0,.7), 0 0 80px rgba(80,30,160,0.35), 0 0 160px rgba(80,30,160,0.18), inset 0 1px 0 rgba(255,255,255,.08)",
            padding: 12,
            flexShrink: 0,
          }}>
            {/* Power button */}
